...
public class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.9934657051; // SparkFun OTOS Note: you can probably leave this at 1
        public double lateralInPerTick = 0.46640697127345; //0.736834497757;// OTOS: 0.872882;
        public double trackWidthTicks = 13.58; //12.791; // otos 12.66;

        // feedforward parameters (in tick units)
        public double kS = 1.5671283484155358; //0.7635681070147831; // OTOS: 0.563756515907424;
        public double kV = 0.1335; //0.1946438443334511; // OTOS:0.19141851548064043;
    ...
    public TrajectoryActionBuilder actionBuilderAddedCorrection(Pose2d beginPose) {
        return new TrajectoryActionBuilder(
                TurnAction::new,
