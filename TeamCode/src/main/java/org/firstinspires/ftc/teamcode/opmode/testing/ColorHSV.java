...
public class ColorHSV extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            Globals.SampleColorDetected colorDetected = detectSampleColor2(hue, sat, val);
    ...
    public static Globals.SampleColorDetected detectSampleColor2(float hue, float sat, float val) {
